...
in French) is a game invented by the Surrealists
          ...
          words or images, according to an agreed rule.
        </p>
        <p>
          This game seeks to mimic the original by randomly generating word lists then combining the
          results to create intriguing combinations that may be chosen for &lsqo;workshopping&rsqo;
